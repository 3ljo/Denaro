...
// images
import banner_bg_shape from '@t/assets/img/slider/banner_bg_shape3-1.jpg';
import banner_bg from '@t/assets/img/slider/banner_bg3.png';
import slider_shape_1 from '@t/assets/img/slider/slider_shape3-1.svg';
import slider_shape_2 from '@t/assets/img/slider/slider_shape3-2.svg';
import slider_shape_3 from '@t/assets/img/slider/slider_shape3-3.svg';
import thumb_bg_shape from '@t/assets/img/slider/thumb_bg_shape3-1.jpg';
import hero_main_img from '@t/assets/img/slider/slider_img03.png';
import bg_img from '@t/assets/img/slider/banner_bg_shape3-2.jpg';
    ...
    return (
        <MouseParallaxContainer>
            <section className="banner__area banner__area-two">
                <div className="banner__bg-shape" style={{ backgroundImage: `url(${bg_img.src})` }}>
