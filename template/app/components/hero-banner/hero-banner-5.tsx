...
import keyboard_img from '@t/assets/img/slider/slider_img05.png';
import banner_bg from '@t/assets/img/slider/banner_bg5.png';
import banner_bg_shape from '@t/assets/img/slider/banner_bg_shape5-1.png';
