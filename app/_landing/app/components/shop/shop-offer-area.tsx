...
import offer_thumb from '@t/assets/img/others/offer-thumb5-1.png';
import Link from "next/link";
import bg_img from '@t/assets/img/bg/offer_bg5.png';


export default function ShopOfferArea() {
    return (
        <section className="offer__area fix bg-img-cover bg-img-center" style={{ backgroundImage: `url(${bg_img.src})` }}>
