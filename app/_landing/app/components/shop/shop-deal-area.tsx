...
import product_1 from '@t/assets/img/products/product-01.png';
import product_2 from '@t/assets/img/products/product-02.png';
import product_3 from '@t/assets/img/products/product-03.png';
import product_4 from '@t/assets/img/products/product-04.png';
import product_5 from '@t/assets/img/products/product-05.png';
import product_6 from '@t/assets/img/products/product-06.png';
import bg_img from '@t/assets/img/bg/deal-area_bg.png';
...
export default function ShopDealArea() {
    return (
        <section className="deal__area fix section-pb-120 section-pt-120" style={{ backgroundImage: `url(${bg_img.src})` }}>
