...
import OffCanvas from "@t/app/components/common/off-canvas";
                    ...
                    <div className="container custom-container2">
                        <div className="row">
                            <div className="col-12">
                                <div onClick={() => handleOpenMobileOffCanvas('/audio/click.wav')} className="mobile-nav-toggler">
                                    ...
                                    <nav className="tgmenu__nav">
                                        ...
                                        <div className="tgmenu__action d-none d-md-block">
                                            <ul className="list-wrap">
                                                ...
                                                <li onClick={() => handleOpenOffCanvas('/audio/click.wav')} className="side-toggle-icon d-none d-xl-flex">
                                                    <span></span>
                                                    <span></span>
                                                    <span></span>
                                                </li>
